...
export const benepiaServiceOperations: ProjectData = {
  ...
  role: [
    ...
    "Broke down finance, public-sector, and telecom client policies into feature scope and data-reflection scope aligned with the shared platform structure",
  ...
  contributions: [
    ...
    "For reservation and application features, connected reservation windows, reception windows, time-slot capacity, duplicate-application limits, privacy consent, and application history",
  ...
  devops: [
    "Validated member, application, consent, and history-data read/write flows by feature using Oracle DB and MyBatis/SQL, including whether operational tracking remained possible",
  ...
  results: [
    ...
    "Connected screen behavior, backoffice features, and database history flows across major domains such as welfare cards, reservations/applications, privacy/consent, and public welfare menus",
  ...
  architectureGroups: [
    ...
    },
    {
      ...
      items: ["Oracle DB", "MyBatis / SQL", "History Tables", "Member / Consent / Request Data"]
    },
    {
