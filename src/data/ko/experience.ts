  ...
  items: [
    {
      ...
      bullets: [
        "2026년부터 여행/레저 제휴 연동 메인 담당으로 상품·주문 수집 API/Batch와 검색 노출 흐름을 주도하고, 한국관광공사(KTO) 휴가샵 웹·앱 서비스 개발/운영을 병행",
        "2025년부터 한국관광공사(KTO) 휴가샵 업무를 유지하면서 여행/레저 제휴 연동으로 책임 범위를 확장하고, 외부 제휴사와 연결되는 상품·주문·검색 데이터 처리 흐름을 이커머스 서비스 기준으로 체계화",
        "2024.04부터 한국관광공사(KTO) 휴가샵 웹·앱 이커머스 서비스 개발/운영을 담당하며 사용자/관리자/고객사 화면, API, DB/배치, 포인트/통계 흐름을 함께 처리",
