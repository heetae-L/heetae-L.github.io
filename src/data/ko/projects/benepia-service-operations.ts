...
export const benepiaServiceOperations: ProjectData = {
  ...
  role: [
    ...
    "금융·공공·통신 계열 고객사 정책을 공통 플랫폼 구조에 맞춰 기능 범위와 데이터 반영 범위로 분해",
  ...
  contributions: [
    ...
    "사내 진료 예약과 건강/의료성 신청 기능에서 예약 가능 기간, 접수 기간, 시간대 정원, 중복 신청 제한, 개인정보 동의, 신청 이력 흐름을 연결",
  ...
  devops: [
    "Oracle DB와 MyBatis/SQL 기반으로 회원, 신청, 동의, 이력 데이터의 조회/저장 흐름과 운영 추적 가능 여부를 기능 단위로 검증",
  ...
  troubleshooting: [
    ...
    "보안 조치성 업무에서는 취약점을 닫는 것에서 끝내지 않고 기존 로그인, 신청, 조회, 동의 저장 흐름이 유지되는지 함께 검증"
  ],
  results: [
    "금융·공공·통신 계열 고객사 요구사항을 공통 복지 커머스 플랫폼 위의 서비스 기능으로 구현",
    "복지카드, 예약/신청, 개인정보/동의, 공공 복지 메뉴 등 주요 기능 영역에서 화면, 백오피스, DB 이력 흐름을 연결",
    "ISMS/e-privacy 보안 조치를 기존 로그인, 신청, 조회, 동의 저장 흐름을 깨지 않도록 반영",
    "고객사별 예외 정책과 공통 플랫폼 구조를 함께 다루며 운영 중인 서비스의 변경 영향 범위 분석 역량 확보",
    "이후 KTO/휴가샵, 여행·레저 제휴 연동 업무에서도 복지 커머스와 운영형 플랫폼 개발 관점을 확장"
  ],
  sectionLabels: {
