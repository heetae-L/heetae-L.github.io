...
export const ktoHyugashopQualityReporting: ProjectData = {
  ...
  role: [
    ...
    "부적합 상품 관리, 메시지 대상 업로드, 국회요구자료 통계, 일일 리포트 등 운영 기능 프로젝트 설계·구현",
  ...
  troubleshooting: [
    "국회요구자료 통계 기능에서 주문·포인트 거래 원천, 회원 기준, 상품 유형, 지역, 포인트 그룹 기준을 함께 맞춰야 하는 통계 산출 흐름 정리",
  ...
  results: [
    "공공기관 기반 휴가 복지 커머스 서비스에서 사용자 기능과 운영 기능을 연결하는 기능 프로젝트 구현",
    "국회요구자료 통계, 주문/포인트 사용내역, 일일 리포트 등 공공 통계·리포트 산출 기준을 시스템 기능으로 정리",
  ...
  architectureNote: "휴가샵 Web/App 서비스와 사용자, 운영, 고객사, API, DB, Batch 데이터 기준을 연결하는 구조"
};
