...
export const ktoHyugashopQualityReporting: ProjectData = {
  ...
  category: "Commerce",
  icon: "cart",
  title: "한국관광공사(KTO) 휴가샵 웹·앱 서비스 개발/운영",
  summary:
    "한국관광공사(KTO) 휴가샵 웹·앱 이커머스 서비스에서 사용자 채널, 운영/고객사 채널, API, DB/배치, 포인트/통계 흐름을 함께 다룬 서비스 개발 경험",
  tags: ["Java", "Spring", "Oracle", "Batch"],
  featured: true,
  homeOrder: 4,
  overview:
    "한국관광공사(KTO) 휴가샵은 근로자 휴가지원사업 참여 근로자가 여행 적립 포인트로 국내 여행·숙박·레저 상품을 구매하는 휴가 복지 이커머스 웹·앱 서비스.\n\n사용자 웹·앱의 상품 탐색, 주문/포인트 사용, 검색/노출 흐름과 관리자·고객사 화면, API, DB/배치, 통계/리포트 흐름이 함께 연결되는 구조.\n\n2024년 4월부터 휴가샵 서비스의 사용자 채널과 운영 채널을 함께 담당하며 기능 개발, 데이터 기준 정비, 화면/배치 연계 흐름 개선을 수행.",
  problem:
    "휴가샵 서비스는 단일 화면 변경으로 끝나지 않고 사용자 웹·앱, 관리자, 고객사 화면, API, DB/배치, 검색/통계 데이터가 함께 움직이는 구조.\n\n여행 적립 포인트는 근로자 20만원, 기업 10만원, 정부 10만원이 합산된 40만원 구조이고 내부 데이터에서는 재원별 포인트 구분이 나뉜다. 주문, 사용, 취소, 통계 집계 시 단순 금액 합산보다 포인트 그룹 기준과 서비스 화면 반영 기준을 함께 확인해야 하는 도메인.",
  role: [
    "한국관광공사(KTO) 휴가샵 웹·앱 이커머스 서비스 개발/운영 담당",
    "사용자 웹·앱, 관리자 화면, 고객사 화면, API, DB/배치 흐름을 함께 확인하며 기능 요구사항과 데이터 기준 설계",
  ...
  results: [
    "공공기관 기반 휴가 복지 이커머스의 사용자 웹·앱과 운영/고객사 채널을 연결하는 서비스 기능 개발",
  ...
  architecture: [
    ...
    "Oracle DB",
    "Batch / Report",
    "Search / Exposure Rules"
  ],
  architectureNote: "Commerce Service / Admin / DB / Batch Flow"
};
